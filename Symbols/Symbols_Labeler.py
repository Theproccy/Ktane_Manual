...
# window layout
layout = [
    [Gui.Text(text="Image " + str(i + 1), key="-IMAGE LABEL TEXT-")],
    ...
    [
        Gui.Button(
            button_text="Save", tooltip="Used to save all of the names to the file"
        )
    ],
]
...
while True:  # main loop
    ...
    if event == "Save":  # overwrites json file
        ...
        data.update({"FILENAMES_LIST": FILENAMES_LIST, "NAMES_LIST": names_list})
