def solve_maze(
    ...
    if (
        ...
        current_coordinates in explored_coordinates
    ):  # check if we have explored the cord
        pass
    else:
        ...
        if current_coordinates[1] >= 1:
            if not (
                maze["horizontal_wall"][current_coordinates[1] - 1][
                    current_coordinates[0]
                ]
            ):
                answer_list = solve_maze(
                    start_coordinates,
        ...
        if current_coordinates[1] < 5:
            if not (
                maze["horizontal_wall"][current_coordinates[1]][current_coordinates[0]]
            ):
                answer_list = solve_maze(
                    start_coordinates,
                    [current_coordinates[0], current_coordinates[1] + 1],
        ...
        if current_coordinates[0] >= 1:
            if not (
                maze["vertical_wall"][current_coordinates[1]][
        ...
        if current_coordinates[0] < 5:
            if not (
                maze["vertical_wall"][current_coordinates[1]][current_coordinates[0]]
            ):
                answer_list = solve_maze(
                    start_coordinates,
                    [current_coordinates[0] + 1, current_coordinates[1]],
